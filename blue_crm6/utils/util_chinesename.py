...
SURNAME_LIST = [
    ...
    "邝", "还", "宾", "闾", "辜", "纵", "?", "万俟", "司马", "上官", "欧阳", "夏侯", "诸葛",
    "闻人", "东方", "赫连", "皇甫", "羊舌", "尉迟", "公羊", "澹台", "公冶", "宗正", "濮阳", "淳于",
    "单于", "太叔", "申屠", "公孙", "仲孙", "轩辕", "令狐", "钟离", "宇文", "长孙", "慕容", "鲜于",
    "闾丘", "司徒", "司空", "兀官", "司寇", "南门", "呼延", "子车", "颛孙", "端木", "巫马", "公西",
    "漆雕", "车正", "壤驷", "公良", "拓跋", "夹谷", "宰父", "谷梁", "段干", "百里", "东郭", "微生",
    "梁丘", "左丘", "东门", "西门", "南宫", "第五", "公仪", "公乘", "太史", "仲长", "叔孙", "屈突",
    "尔朱", "东乡", "相里", "胡母", "司城", "张廖", "雍门", "毋丘", "贺兰", "綦毋", "屋庐", "独孤",
    "南郭", "北宫", "王孙"
]
...
# givenname 名
# return str
def get_name(surname=None):
    if surname is None:
        i = random.randint(0, len(SURNAME_LIST))
        surname = SURNAME_LIST[i]
    head = random.randint(0xb0, 0xf7)
    body = random.randint(0xa1, 0xf9)
    head1 = random.randint(0xb0, 0xf7)
    body1 = random.randint(0xa1, 0xf9)
    val = f'{head:x}{body:x}{head1:x}{body1:x}'
    givenname = bytes.fromhex(val).decode('gb2312')
